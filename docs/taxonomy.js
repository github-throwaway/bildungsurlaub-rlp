...
const REFINE_BUCKETS = [
  ...
  { id: "aufstieg",    name: "Fachwirt, Meister & Techniker", re: /fachwirt|betriebswirt\b|industriemeister|meisterprüfung|handwerksmeister|fachmeister|techniker|fachkaufmann|bilanzbuchhalter/i },
  { id: "studium",     name: "Berufsbegleitendes Studium", re: /semester|bachelor|\bmaster\b|\bmba\b|fernstudi|studiengang|präsenztage|hochschulzertifikat|\(fh\)|\bba\b professional/i },
